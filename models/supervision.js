...
var supervision_schema = new mongoose.Schema({
    name: {
        type: String,
        required: true,
        unique: true
...
var supervision_versions_schema = new mongoose.Schema({
  refId: mongoose.Schema.Types.ObjectId,
  versions: [supervision_schema]
});

var SupervisionQuestions = mongoose.model("SupervisionQuestions", supervision_schema);
var SupervisionQuestionsVersions = mongoose.model("SupervisionQuestionsVersions", supervision_versions_schema);
...
module.exports = {SupervisionQuestions, SupervisionQuestionsVersions};
